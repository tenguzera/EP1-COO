...
public class Player {
	...
	*/
	...
	public void moveUp(long delta){
		double travelled = this.speed * delta;
		double topo = this.cy - (this.height/2);

		if(topo - travelled > v_limit[0]) this.cy -= travelled;
			else this.cy = this.v_limit[0] + (this.height/2);
	}
	...
	*/
	...
	public void moveDown(long delta){
		...
		if(fundo + travelled < v_limit[1]) this.cy += travelled;
			else this.cy = this.v_limit[1] - (this.height/2);
	}
